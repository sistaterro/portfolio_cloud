...
6. **Santo Rosario:** App Android offline para rezar el Santo Rosario, construida con HTML/CSS/JS vanilla y Capacitor (azul profundo/pergamino/dorado, icono de rosario, enfoque sereno y legible para personas mayores).
7. **AI Mascot:** Widget JavaScript embebible para mascotas de IA (verde/turquesa/lima, amigable, API pequeña, logo sonriente), conservado en hide dentro del grid principal.
8. **Audiobook Generator TTS:** Pipeline local XTTS para audiolibros (violeta/cian/ámbar, icono de onda de audio, enfoque long-form/ACX).
9. **CodeRisk AI / PR Sentinel:** Reviewer de riesgo para pull requests asistido por IA (púrpura/cian/ámbar, dashboard técnico, icono tipo escudo/sentinel), conservado en hide dentro del grid principal.
10. **NexusGrid:** Estética Cyberpunk/High-tech (Azules/Cian, Share Tech Mono), conservado en hide dentro del grid principal.
11. **SolTech:** Fusión Solar-Tech (Naranjas/Amarillos, Outfit/Rajdhani), conservado en hide dentro del grid principal.
12. **Verdant:** Diseño Orgánico/Sostenible (Verdes/Menta, DM Sans), conservado en hide dentro del grid principal.
13. **Lumex:** Neon-Futurism (Púrpuras/Cian, Exo 2), conservado en hide dentro del grid principal.
14. **TalkingDutch:** Branding Institucional Holandés (Rojo/Blanco/Azul/Naranja), conservado en hide dentro del grid principal.
...
- **Orden visible del grid:** `Lighttown Barbershop`, `Emma 3.0`, `Emma Node`, `Aesthetic Store`, `Santo Rosario` y `Audiobook Generator TTS`.
...
- **SolTech:** La card de `soltech_english.html` permanece en `card-hidden`; su espacio visible fue reemplazado por Santo Rosario.
...
- **AI Mascot:** La card enlaza `https://github.com/sistaterro/ai_mascot` pero permanece en `card-hidden`.
